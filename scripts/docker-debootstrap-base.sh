...
# repository related
IMAGE="pro-manage.net/debian"
CODENAME="wheezy"
MIRROR="http://mirrors.linode.com/debian/"
SECTIONS="main contrib non-free"
SOFTWARE="iproute,iputils-ping,apt-utils,dialog,wget,screen,locales"
...
run "/opt/dockerbuilds/src/contrib/mkimage-debootstrap.sh -i '$SOFTWARE' $IMAGE $CODENAME $MIRROR"
